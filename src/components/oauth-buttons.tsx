...
export function OAuthButton({ provider, children, className = '' }: OAuthButtonProps) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className={`flex items-center justify-center gap-2 px-4 py-2 rounded-lg border font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${className}`}
    >
