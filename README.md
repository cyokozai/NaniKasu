...
一緒にいいものを作ろうという意思を持つ方であれば歓迎します

- 非エンジニアの方
  - Web3.0の講義に意欲的に参加しており、、自走して学ぶ意欲のある人
  - Discordコミュニティで頻繁に活動しており、オンライン/オフラインでのコミュニケーションが取れる人

- エンジニアの方
  - プロジェクトマネジメントの経験がある人
  - フロントエンド開発の経験がある人
  - バックエンドやデータベース開発の経験がある人

【自分の関わり方】  

学生なので素人ですが普段からサークルや仕事で以下のことを行っています

- アイデア出し
- プログラマ (Go, Python)
- サービスのデプロイ (ちょこっとセキュリティもやる)
- 技術選定
- プロジェクトマネジメント (素人)

研究活動や自分のプロジェクトなどを複数抱えているため、これらすべてを担うことはできません
作業分担をしチームメンバー同士で作業時間を合わせて作業したいと考えています
時間調整が難しい場合は定例MTGなどで進捗確認とリリースまでの取捨選択ができればと思います

【実現可能性チェック】 チェックを付けてください  
　✓ 合法である（違法な内容を含まない）  
　✓ 市場に似たサービスがあるが差別化できそう  
　✓ 学期中に簡易なプロトタイプとして実装できそう  
　✓ 誰かのアイデアやサービスをそのまま真似していない
